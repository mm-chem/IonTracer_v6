...
def plotter(folder):
    ...
    files = generate_filelist(folder, '_mass_loss_per_drop_direct_sub.pickle')
    ...
    hist_out = ax.hist(mass_change_dist, 100, range=[-800000, 800000], color='maroon')
    ...
    try:
        ...
        sigma_constraints = [10000, np.inf]
    ...
    ax.set_title("")
    ax.set_xlabel('Mass Loss', fontsize=24, weight='bold')
    ...
    plt.savefig(analysis_name + '_exported_mass_loss_direct_sub_dist.png', bbox_inches='tight', dpi=300.0,
                transparent='true')
